...
TESTS = [
    ...
    RunGroupConfig(expected_tps=10, key=RunGroupKey("smart-table-picture1-m-with300-change"), included_in=LAND_BLOCKING_AND_C, waived=True),
    RunGroupConfig(expected_tps=40, key=RunGroupKey("smart-table-picture1-m-with300-change", module_working_set_size=20), included_in=Flow.CONTINUOUS, waived=True),
